      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2">
            <div>
              <h2 className="mb-4 text-md font-semibold text-dark-primaryTextColor dark:text-primaryTextColor uppercase">
                Help
              </h2>
              <ul className="text-dark-primaryTextColor dark:text-primaryTextColor font-regular">
                ...
                <li className="mb-2">
                  <a href="/help#tutorials" className="hover:underline">
                    Tutorials
                  </a>
                </li>
                <li className="mb-2">
                  <a href="/help#feedback" className="hover:underline">
                    Provide feedback
                  </a>
                </li>
              </ul>
        ...
        <div>
          <span className="text-sm text-dark-primaryTextColor dark:text-primaryTextColor sm:text-center">
            © 2024 Tech Odyssey. All Rights Reserved.
          </span>
        </div>
      </div>
    </footer>
